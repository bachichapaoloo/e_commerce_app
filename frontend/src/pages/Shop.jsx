                ...
                <main className={shopPageStyles.mainContent}>
                    ...
                    <div className={shopPageStyles.grid}>
                        {filteredProducts.map(product => (
                            <div key={product.id} className={shopPageStyles.card}>
